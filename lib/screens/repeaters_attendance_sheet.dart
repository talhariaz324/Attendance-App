...
class RepeaterAttendanceSheet extends StatefulWidget {
  final String subjName;
  const RepeaterAttendanceSheet({Key? key, required this.subjName})
      : super(key: key);

  @override
  State<RepeaterAttendanceSheet> createState() =>
      _RepeaterAttendanceSheetState();
}

class _RepeaterAttendanceSheetState extends State<RepeaterAttendanceSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final RepStudents students = Provider.of<RepStudents>(context);
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: students.fetchAndSetRepStudent(),
          builder: (ctx, dataSnapshot) {
            ...
            if (dataSnapshot.connectionState == ConnectionState.none) {
              ...
              return students.repeaterStu.isEmpty
                  ? Center(
                  ...
                  : Padding(
                      ...
                      child: Column(children: [
                        ...
                        ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: students.repeaterStu.length,
                          itemBuilder: (ctx, index) {
                            return Dismissible(
                                key: ValueKey(students.repeaterStu[index].id),
                                direction: DismissDirection.endToStart,
                                onDismissed: (direction) {
                                  Provider.of<Students>(context, listen: false)
                                      .deleteNewStud(
                                          students.repeaterStu[index].id);
                                },
                                ...
                                child: ChangeNotifierProvider.value(
                                  value: students.repeaterStu[index],
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        title: Text(
                                          students.repeaterStu[index].name,
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: Theme.of(context)
                                                  .colorScheme
                                        ...
                                        subtitle: Text(
                                          students.repeaterStu[index].rollNo,
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: Theme.of(context)
                                                  .colorScheme
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context).pushNamed(MyRoutes.attendanceScreenRoute);
        },
